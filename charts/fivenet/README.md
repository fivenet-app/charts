...
| `ingressGRPC.hosts[0].paths[0].path` |  | `"/api"` |
| `ingressGRPC.hosts[0].paths[0].pathType` |  | `"Prefix"` |
| `ingressGRPC.hosts[0].paths[1].path` |  | `"/"` |
| `ingressGRPC.hosts[0].paths[1].pathType` |  | `"Prefix"` |
| `ingressGRPC.tls` |  | `[]` |
| `nameOverride` |  | `""` |
